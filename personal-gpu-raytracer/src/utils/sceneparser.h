...
private:
    static void traverseTree (SceneNode* rootNode, std::vector<RenderShapeData>* shapes, glm::mat4 ctm);
    static glm::mat4 accumulateTransformations(std::vector<SceneTransformation*>* transformations);
};
